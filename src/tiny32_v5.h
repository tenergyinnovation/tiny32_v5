 ...
 * Rev3.0       :     Major change hardware from tiny32_v2.0 to tiny32_v5.0
 ...
 *                    must to clone Debounce library to tiny32_v5/src/Debounce
...
public:
    ...
    int8_t RelayModusRTU_searchAddress();
